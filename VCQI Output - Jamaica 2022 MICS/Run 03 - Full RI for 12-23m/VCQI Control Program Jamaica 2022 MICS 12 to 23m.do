...
global VCQI_OUTPUT_FOLDER  Q:/VCQI Output - Jamaica 2022 MICS/Run 03 - Full RI for 12-23m

* Establish analysis name (used in log file name and Excel file name)

global VCQI_ANALYSIS_NAME Jamaica_12_to_23m
...
vcqi_global VCQI_RI_DATASET     MICS_6_to_VCQI_RI_12_to_23m
...
vcqi_global EARLIEST_SVY_VACC_DATE_Y  	2020 // First interview date 12apr2022
...
vcqi_global RI_DOSES_TO_BE_FULLY_VACCINATED bcg polio1 polio2 polio3 penta1 penta2 penta3 
...
vcqi_global RI_CCC_02_PLOT_TITLE "Jamaica 2022 MICS - Ages 12-23m"
...
vcqi_global RI_CIC_02_PLOT_TITLE "Jamaica 2022 MICS - 12-23m"
...
*
* 2022-09-06	1.05	Dale Rhoda		Add global FMTIDS
*
* 2023-07-13	1.06	Dale Rhoda		Reorder doses in VCTC output;
*             							add four VCTC global parameter files;
* 										move AGGREGATE_VCQI_DATABASES call;
*										use scheme s2color for backward 
*                                       compatibility.
* 										
*										Also change labels from MOV to MOSV
*										(program names and globals and vars
*										 still use the string MOV or mov)
*
*                                       Also use make_RI_augmented_dataset_v2
*
* 2023-08-29	1.07	MK Trimner		Added code to call multi lignual program
*
* 2024-03-18	1.08	Dale Rhoda		Added $VCQI_PASS_THRU_VARLIST to
*                                       facilitate custom svyset with extra
*                                       variables, e.g., for fpc()
*
* 2024-01-04	1.09	MK Trimner		Added multi lingual globals
*										changed note in QUAL_07B about CIs to 
*                                       align with other footnotes
*
* 2024-04-25	1.10	MK Trimner		Added TITLE_CUTOFF and FOOTNOTE_CUTOFF to be used in plots
*
* 2024-06-03    1.11    Dale Rhoda      Explicitly show values of SHIFTWITHIN 
*                                       and DROPDUP for dose shift batch 1.
*
* 2025-08-21	1.12	Dale Rhoda		Add IW_UW_XSIZE, IW_UW_YSIZE, 
*                                       IWPLOT_SUPPRESS_TICKS, 
*                                       VCQI_SUPPRESS_OVERALL_IWPLOTS,
*                                       VCQI_SUPPRESS_OVERALL_UWPLOTS
******************************************************************************** 
